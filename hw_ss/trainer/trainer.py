...
class Trainer(BaseTrainer):
    ...
    def move_batch_to_device(batch, device: torch.device):
        ...
        """
        for tensor_for_gpu in ["audio_target", "audio_mixed", "audio_ref", "spectrogram_target", "spectrogram_mixed", "spectrogram_ref", "speaker_id"]:
    ...
    def _log_predictions(
        ...
        tuples = list(zip(audio_target, audio_mixed, predict_wavs, audio_path))
        shuffle(tuples)
        rows = {}
        for audio_target, audio_mixed, pred_wavs, audio_path in tuples[:examples_to_log]:
            rows[audio_path] = {
                "target": audio_target,
